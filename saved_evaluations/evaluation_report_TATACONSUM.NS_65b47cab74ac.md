...
- **Candidate Model Hash**: `65b47cab74ac`
- **Evaluation Timestamp**: 2026-08-21T09:38:47.517152+00:00
...
|--------|--------|-----------|-------|
| Actionable Precision | 0.2895 | 0.0000 | -0.2895 |
| Actionable Recall | 0.1000 | 0.0000 | -0.1000 |
| Actionable Count | 38 | 0 | -38 |
...
- **Candidate Class Distribution**: {0: 68, 1: 84, 2: 69}
