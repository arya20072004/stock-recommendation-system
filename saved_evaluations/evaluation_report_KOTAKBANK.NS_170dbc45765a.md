...
- **Candidate Model Hash**: `170dbc45765a`
- **Evaluation Timestamp**: 2026-08-20T13:09:39.932950+00:00
...
|--------|--------|-----------|-------|
| Actionable Precision | 0.2021 | 0.0000 | -0.2021 |
| Actionable Recall | 0.1473 | 0.0000 | -0.1473 |
| Actionable Count | 94 | 0 | -94 |
...
- **Candidate Class Distribution**: {0: 61, 1: 70, 2: 90}
