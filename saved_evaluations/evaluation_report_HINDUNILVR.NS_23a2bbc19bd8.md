...
- **Candidate Model Hash**: `23a2bbc19bd8`
- **Evaluation Timestamp**: 2026-08-21T09:38:45.988563+00:00
...
|--------|--------|-----------|-------|
| Actionable Precision | 0.4923 | 0.3832 | -0.1091 |
| Actionable Recall | 0.2319 | 0.2971 | 0.0652 |
| Actionable Count | 65 | 107 | 42 |

## 5. Statistical Evidence (McNemar's Test)
- **Applicability**: APPLICABLE
- **Test Statistic**: 0.0
- **p-value**: 1.0
- **Actionable Sample Size (Intersection)**: 54
*(Note: Temporal dependence in observations limits strict p-value interpretation)*

## 6. Economic Evidence (Simulated Actionable Cumulative Return)
- **Active Return**: 84.66%
- **Candidate Return**: 32.25%
- **Delta**: -52.41%
- **Transaction Costs**: NOT MODELED

## 7. Robustness
- **Active Class Distribution**: {0: 61, 1: 125, 2: 35}
- **Candidate Class Distribution**: {0: 69, 1: 74, 2: 78}
