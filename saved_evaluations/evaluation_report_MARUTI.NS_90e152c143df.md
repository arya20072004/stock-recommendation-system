...
- **Candidate Model Hash**: `90e152c143df`
- **Evaluation Timestamp**: 2026-08-21T09:38:46.733599+00:00
...
|--------|--------|-----------|-------|
| Actionable Precision | 0.0000 | 0.2920 | 0.2920 |
| Actionable Recall | 0.0000 | 0.2685 | 0.2685 |
| Actionable Count | 0 | 137 | 137 |
...
- **Active Return**: 0.00%
- **Candidate Return**: 16.38%
- **Delta**: 16.38%
- **Transaction Costs**: NOT MODELED

## 7. Robustness
- **Active Class Distribution**: {0: 56, 1: 116, 2: 49}
- **Candidate Class Distribution**: {0: 153, 1: 68, 2: 0}
