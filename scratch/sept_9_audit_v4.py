...
for r in registry_records:
    model_path = f"saved_models/model_{r['ticker']}_{r['version'][:12]}.joblib"
    feature_path = f"saved_features/features_{r['ticker']}_{r['version'][:12]}.json"
...
print("Audit generated successfully. View scratch/audit_report_final.txt")
